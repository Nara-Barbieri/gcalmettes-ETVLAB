function retrievePubmedQuery(query, limit=60){
	const path = `https://eutils.ncbi.nlm.nih.gov/entrez/eutils/esearch.fcgi?db=pubmed&term=Tarling+EJ%5BAuthor%5D"+and+"de+Aguiar+Vallim+TQ%5BAuthor%5D&retmax=${limit}&retmode=json`
	return fetch(path)
